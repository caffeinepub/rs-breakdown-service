...
export class Backend implements backendInterface {
    ...
    async getRequests(): Promise<Array<ServiceRequest>> {
        if (this.processError) {
            try {
    ...
    async submitRequest(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitRequest(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
